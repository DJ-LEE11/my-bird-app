/**
 *  SSDK v2.6.5.1，集成和使用方法，请参考《iOS安全SDK使用文档》
 ...
 * 特定事件（如支付、登录）发生时查询ztoken的接口
 ...
 @param eventInfo包含eventID和accountID信息的字典:{ kSSDKEventIdentifier: (NSString*)eventID, kSSDKAccountIdentifier:(NSString*)accountID}
...
- (void)deleteAccountWithUID:(NSString *)uid cuid:(NSString *)cuid accountId:(NSString *)accountId;
