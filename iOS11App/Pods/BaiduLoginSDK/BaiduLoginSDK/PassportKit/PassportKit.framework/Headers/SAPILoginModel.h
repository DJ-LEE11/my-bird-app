...
/**
 ...
 注意：该字段可能为空。由于该字段从 8.7.3 版本加入，存量帐号无法获取对应的 bundleId（直接获取当前App的bundleId会造成app字段和bundleid字段不匹配）
 */
@property (nonatomic, copy, readonly) NSString *sourceBundleID;
...
/**
*  返回一个删除bduss、uid的SAPILoginModel实例
*
*  @return SAPILoginModel实例
*/
- (SAPILoginModel *)removeBdussAndUid;
