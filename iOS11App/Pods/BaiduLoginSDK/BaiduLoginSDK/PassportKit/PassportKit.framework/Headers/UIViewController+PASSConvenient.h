...
- (void)pass_presentViewController:(UIViewController *)ctrl animated:(BOOL)animated completion:(void (^)(void))completion configPresentedCtrl:(void (^)(UIViewController *presentedCtrl))config;
...
- (void)pass_presentViewControllerInContainer:(UIViewController *)ctrl animated:(BOOL)animated completion:(void (^)(void))completion configPresentedCtrl:(void (^)(UIViewController *presentedCtrl))config ;
